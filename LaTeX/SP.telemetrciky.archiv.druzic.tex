...
% Az érdemi szöveg itt kezdődik.
  \include{text/01-uvod}
  \include{text/02-reseni}
  \include{text/03-vysledky}
  \include{text/04-zaver}
  \include{text/05-literatura}
  \include{text/06-zkratky}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Csatolmányok
  \prilohy
  \seznampriloh
  \include{text/07-prilohy}
